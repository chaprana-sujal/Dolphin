...
// Load begins streaming logs and stats for the given container.
...
func (d *Details) streamLogs(ctx context.Context) {
	opts := dockerclient.ContainerLogsOptions{ShowStdout: true, ShowStderr: true, Follow: true, Tail: "50"}
